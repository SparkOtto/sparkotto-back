...
class KeyService {
    ...
    async createKey(data: { key_name: string; agencyId: number; vehicleKeyId: number }) {
    ...
    async updateKey(id_key: number, data: { key_name?: string; agencyId?: number; vehicleKeyId?: number }) {
