...
CREATE TABLE "Domaines" (
    ...
    "domaine_name" TEXT NOT NULL,

    CONSTRAINT "Domaines_pkey" PRIMARY KEY ("id_domaine")
);
...
CREATE TABLE "Keys" (
    ...
    "agency_id" INTEGER NOT NULL,
    "comment" TEXT,
    "vehicleKeyId" INTEGER NOT NULL,

    CONSTRAINT "Keys_pkey" PRIMARY KEY ("id_key")
);

-- CreateIndex
CREATE UNIQUE INDEX "Domaines_domaine_name_key" ON "Domaines"("domaine_name");
...
-- AddForeignKey
ALTER TABLE "Trips" ADD CONSTRAINT "Trips_departure_agency_fkey" FOREIGN KEY ("departure_agency") REFERENCES "Agencies"("id_agency") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "Trips" ADD CONSTRAINT "Trips_arrival_agency_fkey" FOREIGN KEY ("arrival_agency") REFERENCES "Agencies"("id_agency") ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "Keys" ADD CONSTRAINT "Keys_agency_id_fkey" FOREIGN KEY ("agency_id") REFERENCES "Agencies"("id_agency") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "Keys" ADD CONSTRAINT "Keys_vehicleKeyId_fkey" FOREIGN KEY ("vehicleKeyId") REFERENCES "Vehicles"("id_vehicle") ON DELETE RESTRICT ON UPDATE CASCADE;
